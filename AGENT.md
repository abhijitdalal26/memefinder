...
data/curated/<sub>/*.jpg  # 52k+ images (~13 GB) — uploaded to Kaggle (abhijitdalal26/memesdataset) + Drive
...
## Kaggle dataset (2026-08-24)
- Published: `abhijitdalal26/memesdataset` — https://www.kaggle.com/datasets/abhijitdalal26/memesdataset
- 52k memes, 21 subreddits (`memes` split into `memes_1/_2/_3`), `curated_metadata.json`, `README.md`. **Private** → make Public in Settings.
- GPU embedding training: `MAKEMEME_CATALOG=/kaggle/input/memesdataset/curated_metadata.json`, `MAKEMEME_IMAGES=/kaggle/input/memesdataset`.
- Staging dir `kaggle_upload/` is gitignored (13 GB). Config + notebook steps: `kaggle_upload/dataset-metadata.json`, `kaggle_upload/README.md`.
...
- [x] Upload to Kaggle: `abhijitdalal26/memesdataset` (52k memes + catalog) — DONE 2026-08-24 (private)
- [ ] Make Kaggle dataset Public (Settings → Public)
